...
class Excel:
    def __init__(self, wb, sheet):
        ...
        self.i = 1
        self.sheet = sheet
        sheet.write(0, 0, 'ResNet50V2For2')
...
base_model = ResNet50V2(include_top = False, input_shape = (150, 150, 3))
x = base_model.output
x = Dropout(0.5)(x)
...
filepath="transferlearning_weightsResNet50V2For2.hdf5"
...
model.load_weights("transferlearning_weightsResNet50V2For2.hdf5")
...
listData3.listToExcel(cmScore, ps, rs, f1, aps, bas, bsl, fbs, hl, zol, rac)
listData3.wb1.save('ResNet50V2For2.xls')
...
plot_model(model, to_file='ResNet50V2For2.jpeg', dpi = 1500)
