...
class Excel:
    def __init__(self, wb, sheet):
        ...
        self.i = 1
        self.sheet = sheet
        sheet.write(0, 0, 'DenseNet121For2')
...
filepath="transferlearning_weightsDenseNet121For2.hdf5"
...
model.load_weights("transferlearning_weightsDenseNet121For2.hdf5")
...
listData4.listToExcel(cmScore, ps, rs, f1, aps, bas, bsl, fbs, hl, zol, rac)
listData4.wb1.save('DenseNet121For2.xls')
...
plot_model(model, to_file='DenseNetFor2.jpeg', dpi = 768)