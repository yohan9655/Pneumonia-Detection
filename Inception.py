# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 00:15:46 2019
...
filepath="transferlearning_weightsInceptionV1For2New.hdf5"
...
model.load_weights("transferlearning_weightsInceptionV1For2.hdf5")
...
listData1.wb1.save('InceptionV1For2.xls')
...
plot_model(model, to_file='InceptionV3For2.jpeg', dpi = 768)